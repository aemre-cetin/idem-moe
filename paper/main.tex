...
\begin{table*}[t]
\centering
\caption{Empirical Hardware Performance Comparison of Mixture-of-Experts Token Routing on NVIDIA Blackwell Architecture (\texttt{sm\_120})}
\label{tab:results}
\small
